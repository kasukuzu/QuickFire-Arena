...
export default function CharacterModel({ characterId, crouching = false, alive = true, invincible = false }: Props) {
  ...
  return (
    <group scale={[1, scaleY, 1]}>
      <Part position={[-0.18, 0.45, 0]} size={[0.28, 0.9, 0.28]} color={character.legs} opacity={opacity} />
      <Part position={[0.18, 0.45, 0]} size={[0.28, 0.9, 0.28]} color={character.legs} opacity={opacity} />
      <Part position={[0, 1.12, 0]} size={[0.7, 0.82, 0.35]} color={character.torso} opacity={opacity} />
      <Part position={[0, 1.18, -0.19]} size={[0.74, 0.14, 0.06]} color={character.accent} opacity={opacity} />
      <Part position={[-0.52, 1.1, 0]} size={[0.25, 0.86, 0.25]} color={character.arms} opacity={opacity} />
      <Part position={[0.52, 1.1, 0]} size={[0.25, 0.86, 0.25]} color={character.arms} opacity={opacity} />
      <Part position={[0, 1.62, 0]} size={[0.6, 0.42, 0.6]} color={character.skin} opacity={opacity} />
      <Part position={[0, 1.81, -0.02]} size={[0.66, 0.12, 0.66]} color={character.helmet} opacity={opacity} />
